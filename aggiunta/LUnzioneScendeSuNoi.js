    ...
    <View style={globalStyles.containerCantico}>
        ...
        <View style={globalStyles.righeCantico}>
            ...
            <Text style={accordiStru!="Testo"? globalStyles.textCantico: globalStyles.textCanticoNo}>ione e ristoro ci d</Text>
                         {accordiStru != "Testo" &&<View><Text style={globalStyles.AccordoCantico}>{a}5 {d}</Text></View> }
        ...
        <View style={globalStyles.righeCantico}>
            <Text style={accordiStru!="Testo"? globalStyles.textCantico: globalStyles.textCanticoNo}>della tua gloria di più</Text>
        </View>
        ...
        <View style={globalStyles.righeCantico}>
            <Text style={accordiStru!="Testo"? globalStyles.textCantico: globalStyles.textCanticoNo}>perché sappiam che c'è an</Text>
            {accordiStru != "Testo" &&<View><Text style={globalStyles.AccordoCantico}>7</Text></View> }
